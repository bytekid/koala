...
if __name__ == "__main__":
  ...
  for u in usable:
    ...
    none = "<!--none-->" if not(epr or mon or two_var or guarded or ground or pvd or restr) else ""
    props = [epr, mon, two_var, guarded, ground, pvd, restr, none]
