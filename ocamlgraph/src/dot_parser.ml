...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 102 "src/dot_parser.mly"
                           ( _2 :: _3 )
# 347 "src/dot_parser.ml"
               : 'edge_rhs))
; (fun __caml_parser_env ->
    Obj.repr(
# 106 "src/dot_parser.mly"
                ( [] )
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 116 "src/dot_parser.mly"
              ( _1, _2 )
# 383 "src/dot_parser.ml"
               : 'node_id))
; (fun __caml_parser_env ->
    Obj.repr(
# 120 "src/dot_parser.mly"
                ( None )
